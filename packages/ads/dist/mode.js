...
exports.useTestAdUnit = useTestAdUnit;
exports.isTestAds = isTestAds;
exports.ssvRequestOptions = ssvRequestOptions;
/** Metro 가 expo-updates 를 CJS/ESM 어느 쪽으로 주든 채널 이름을 꺼낸다 */
function readUpdateChannel(mod) {
    const m = mod;
 ...
 */
function ssvRequestOptions(useTestAds, userId, customData) {
    if (useTestAds)
        return {};
